...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/18 12:00:57 by lgerard           #+#    #+#             */
/*   Updated: 2025/07/18 12:00:57 by lgerard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pars_amb(t_app *app)
{
	...
	app->scene.amb_set = 1;
	if (count_token(app->token) < 2 || count_token(app->token) > 3)
